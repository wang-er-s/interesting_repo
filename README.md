...
- [AingDesk](https://github.com/aingdesk/AingDesk) 简单易用的桌面AI助手，支持知识库与本地模型


## AI客户端

- [chatbox](https://github.com/chatboxai/chatbox) 支持多模型的跨平台桌面AI聊天客户端
...
- [OpenMAIC](https://github.com/THU-MAIC/OpenMAIC) 一键生成多智能体互动课堂的开源平台
...
- [Folo](https://github.com/RSSNext/Folo) AI 驱动的多平台 RSS 阅读器，聚合信息流
...
- [GOAP](https://github.com/crashkonijn/GOAP) 适用于Unity的多线程GOAP游戏AI规划系统
...
- [unity-mcp](https://github.com/CoplayDev/unity-mcp) 让AI助手通过MCP直接操作Unity编辑器


## UnityUI

- [ParticleEffectForUGUI](https://github.com/mob-sakai/ParticleEffectForUGUI) Unity中在uGUI里渲染可遮罩可排序粒子特效
...
- [AssetRipper](https://github.com/AssetRipper/AssetRipper) 用于提取并转换 Unity 资源与资源包的工具
- [obfuz](https://github.com/focus-creative-games/obfuz) Unity 开源代码混淆与加固插件，支持热更新
- [FastScriptReload](https://github.com/handzlikchris/FastScriptReload) Unity 脚本热重载工具，快速迭代不中断运行
...
- [com.unity.ide.cursor](https://github.com/boxqkrtm/com.unity.ide.cursor) Unity 集成 Cursor 代码编辑器的插件
...
- [UnityNativeGallery](https://github.com/yasirkula/UnityNativeGallery) Unity 原生插件，支持安卓和iOS相册读写图片视频
- [UnityRuntimeInspector](https://github.com/yasirkula/UnityRuntimeInspector) Unity 运行时检查器与层级视图调试编辑插件
...
- [Unity-Script-Collection](https://github.com/michidk/Unity-Script-Collection) 收录免费实用的 Unity 脚本、库与插件合集


## Unity资源管理

- [YooAsset](https://github.com/tuyoogame/YooAsset) Unity3D游戏资源管理与热更新系统


## VSCode扩展

- [unity-code](https://github.com/hackerzhuli/unity-code) 增强 VS Code 的 Unity 开发扩展
...
- [caesium-image-compressor](https://github.com/Lymphatus/caesium-image-compressor) 跨平台图片压缩工具，支持JPG、PNG、WebP和TIFF


## 备份工具

- [oh-my-wechat](https://github.com/chclt/oh-my-wechat) 本地查看与还原微信备份聊天记录的阅读器
...
- [minimind](https://github.com/jingyaogong/minimind) 从零训练64M小型GPT的大模型教程与代码
...
- [AI_NovelGenerator](https://github.com/YILING0013/AI_NovelGenerator) 基于 AI 的多章节长篇小说生成与上下文衔接工具


## 工具清单

- [indie-hacker-tools-plus](https://github.com/XiaomingX/indie-hacker-tools-plus) 独立开发者常用技术栈与工具精选清单
...
- [LibreTV](https://github.com/LibreSpark/LibreTV) 轻量级在线视频搜索与观影平台


## 影音播放

- [iptv-api](https://github.com/Guovin/iptv-api) IPTV直播源自动采集筛选测速与生成平台
...
- [pansou](https://github.com/fish2018/pansou) 高性能网盘资源搜索API服务，支持TG与插件搜索
...
- [pandoc](https://github.com/jgm/pandoc) 支持多种文档标记格式互转的通用转换器
- [markitdown](https://github.com/microsoft/markitdown) 将多种文件与Office文档转换为Markdown的Python工具


## 服务器管理

- [xpipe](https://github.com/xpipe-io/xpipe) 本地桌面统一访问和管理服务器基础设施的连接中心
...
- [Pake](https://github.com/tw93/Pake) 一键将任意网页打包为跨平台桌面应用
...
- [OpenDeepWiki](https://github.com/AIDotNet/OpenDeepWiki) 开源AI代码知识库与协作文档平台
...
- [115-plus-desktop](https://github.com/lvzhenbo/115-plus-desktop) 基于Tauri与Vue3的115网盘第三方桌面客户端


## 网盘管理

- [alist](https://github.com/AlistGo/alist) 支持多存储的文件列表与 WebDAV 程序


## 网页归档

- [monolith](https://github.com/Y2Z/monolith) 将完整网页保存为单个HTML文件的CLI工具


## 翻译工具

- [TTime](https://github.com/InkTimeRecord/TTime) 支持截图划词OCR与AI翻译的桌面软件
- [pot-desktop](https://github.com/pot-app/pot-desktop) 跨平台划词翻译与OCR识别桌面工具


## 考公指南

- [coder2gwy](https://github.com/coder2gwy/coder2gwy) 程序员考公考编与教师上岸经验指南


## 聊天机器人

- [AstrBot](https://github.com/AstrBotDevs/AstrBot) 多平台集成的开源智能聊天机器人基础设施


## 舆情监控

- [TrendRadar](https://github.com/sansan0/TrendRadar) AI多平台舆情监控与热点聚合推送工具
